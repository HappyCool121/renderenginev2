...
// Handles windows, imgui overlay, scene data (object states, textures, texture maps)
...
// will handle all variables and objects in the scene, including the render settings
// serves as the orchestrator for the whole application
...
inline float FOVscale = (HEIGHT / 2.0f) / std::tan(cameraFOV * 0.5f * 3.14159f / 180.0f);
